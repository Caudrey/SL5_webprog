...
<body>
    ...
    <main class="d-flex">
        ...
        <div class="d-flex flex-column align-items-center content">
            ...
            {{-- Timeline --}}
            <div class="education container px-4 mt-3 align-items-center">
                  ...
                  <div class="col-md-12 ps-5">
                    <div id="tl">
                      <ul class="timeline-1 text-white">
                        ...
                        <li class="event" data-date="2009 - 2011">
                            <h4 class="mb-3 pt-3">SD Perguruan Buddhi</h4>
                            <p>Elementary school</p>
                        </li>
                        <li class="event" data-date="2011 - 2015">
                            <h4 class="mb-3 pt-3">SD Tarakanita Gading Serpong</h4>
                            <p>Elementary school</p>
                        </li>
                        <li class="event" data-date="2015 - 2018">
                            <h4 class="mb-3 pt-3">SMP Tarakanita Gading Serpong</h4>
                            <p>Junior high school</p>
                        </li>
                        <li class="event" data-date="2018 - 2021">
                            <h4 class="mb-3 pt-3">SMA Tarakanita Gading Serpong</h4>
                            <p>Senior High School</p>
                        </li>
                        <li class="event" data-date="2021 - Now">
                            <h4 class="mb-3 pt-3">Binus University (PPTI BCA)</h4>
